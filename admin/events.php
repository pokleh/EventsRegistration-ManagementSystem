                ...
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                          <a href="addevent"><i class="fa fa-plus-circle"></i> Add New Event</a>
                        </div>
                        <!-- /.panel-heading -->
...
$select = "SELECT * FROM events";
                             ...
                             ?>
                                    ...
                                    <td><?php echo "₱" . number_format($row['eventPrice']) ?></td>
                                   
                      <th style="text-align:center;"><a href="viewevent?id=<?php echo $row['id']; ?>"class="btn btn-info btn-sm">View / Edit</a>
                        <button class="btn btn-danger btn-sm delete" style="float:right;margin-right:10px;" id="<?php echo $row['id']; ?>">Delete </button>
                      </th>
