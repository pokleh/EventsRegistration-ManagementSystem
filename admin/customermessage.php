...
<thead>
                <tr>
                            ...
                            <?php
$select = "SELECT user_account.fullName,user_account.userID,clientmessage.id,clientmessage.userID,clientmessage.subject,clientmessage.message,clientmessage.dateSent,clientmessage.status 
FROM clientmessage 

INNER JOIN user_account ON clientmessage.userID = user_account.userID
 WHERE deleteStatusAdmin = ''
ORDER BY clientmessage.status DESC ";
                             ...
                             ?>
                                ...
                                else
                                {
                                    ...
                                    <td>
                                    <a class="btn btn-info btn-sm" href="readcustomermessage?id=<?php echo $row['id'] ?>&&userid=<?php echo $row['userID'] ?>">Read</a>
...
if(confirm('Do you really want to delete this message?'))
{
    ...
    $.ajax({
        ...
        type:'post',
        url:'php/deleteMessageClient.php',
        data:{id:id},
        success:function(x)
        {
            $("#ajax_catcher").html(x);
