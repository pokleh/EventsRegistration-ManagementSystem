...
if($pax == "all")
 ...
 {
 	$query = "SELECT COUNT(*) AS totalClient,sum(price) AS totalPrice, dateReserved, eventCategory FROM sales WHERE  YEAR(dateReserved) = '$year' AND pax = '$pax' AND eventCategory = 'christening'  GROUP BY MONTH(dateReserved) ORDER BY dateReserved ASC";  
