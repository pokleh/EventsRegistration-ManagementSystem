            ...
            <div class="row about_inner">
              ...
              <div class="col-lg-12">
                <br>       <div id="ajax_cathcher"></div>
                     ...
                     $select = $connection->query("SELECT * FROM reply WHERE userID = '$userID' AND statusDelete=''  GROUP BY messageID ORDER BY dateSent DESC");
                        while($row = $select->fetch_assoc())
                            { 
                              ...
                              ?>
                                ...
                                <tr style="cursor:pointer;" class="read" id="<?php echo $messageID; ?>">
                                  <td style="width:80px;"><input type="checkbox" id="checkboxes" class="checkboxes" value="<?php echo $messageID; ?>"></td>
                                  

                                   <td><b   <?php if($clientmessage['statusClient']=="seen") { echo "style='color:#cccccc;'"; } ?>><?php echo ucwords($clientmessage['subject']); ?></b> </td>
                                  <td><b   <?php if($clientmessage['statusClient']=="seen") { echo "style='color:#cccccc;'"; } ?>><?php echo ucwords(substr($row['repply'], 0,100)) ?></b> </td>
                                  <td><b   <?php if($clientmessage['statusClient']=="seen") { echo "style='color:#cccccc;'"; } ?>><?php echo date('M-d-Y',strtotime($row['dateSent'])) . " " . date('g:i a',strtotime($row['dateSent'])) ?></b> </td>
