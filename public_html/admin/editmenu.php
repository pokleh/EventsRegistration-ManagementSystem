...
<body>
   ...
   <!-- Navigation -->
    ...
    <?php
$id = mysqli_escape_string($connection,$_GET['id']);
$row = $connection->query("SELECT * FROM menu WHERE menuID ='$id'")->fetch_assoc();
 ?>
 ...
 <div class="row">
  ...
  <div class="form-group">
                ...
                <input type="text" class="form-control" id="menu" value="<?php echo $row['menu'] ?>">
            </div>
      ...
      <div class="col-md-6">
        ...
        <img src="../img/menu/<?php echo $row['img'] ?>" alt="img" id="blah" style="width:500px;height:300px;">
        <br>
        <br>
        <form action="editmenu?id=<?php echo $id; ?>" method="post" enctype="multipart/form-data">
...

{
  ...
  $_SESSION['update'] = 'Menu successfully updated';
...
<div class="row">
    <div class="col-md-12">
        <b>Ingredients:</b> <br>
        <textarea name="" id="ing" style=""><?php echo $row['ing']; ?></textarea>
...
<div class="row">
  ...
  <div class="alert alert-danger" style="width:40%;display:none;"></div>
    ...
    <button class="btn btn-info" style="float:right;" id="update">Update menu</button>
     ...
     var category = $("#category").val();
        ...
        var ing = tinyMCE.get('ing').getContent();
                    ...
                    else
                    {
                            ...
                            if(confirm('Do you really want to update this menu?'))
                                    {

                        $.ajax({

                                type:'post',
                                url:'php/updateMenu.php',
                                data:{menu:menu,category:category,id:id,ing:ing},
                                success:function(x)
                                {
                                    $("#ajax_catcher").html(x);
                                }
