 ...
 <div class="row">
  ...
  <div class="form-group">
      ...
      <div class="col-md-6">
       ...
       <center><img src="../img/notfound.png ?>" alt="img" id="blah" style="width:200px;height:200px;border-radius:100%;"></center> 
        <br>
        <br>
 ...
 if(isset($_POST['submit']))
{
  ...
  $row = $connection->query("SELECT * FROM  testimonials ORDER BY id DESC LIMIT 1")->fetch_assoc();  
  $id = $row['id'];
...
if($update2->execute())
{
  ...
  $_SESSION['update'] = 'Testimonial successfully added';
...
<div class="row">
    <div class="col-md-12">
        <label for="">Tertimonial</label>
        <textarea name="textarea" id="info" cols="30" rows="10" class="form-control"></textarea>
  <br><br>  <br><br>
  <div class="alert alert-danger" style="width:40%;display:none;"></div>
    
    
    <button class="btn btn-info" style="float:right;" id="update">Add Testimonial</button>
    ...
    $("#update").click(function(){
     ...
     var id = <?php echo $id; ?>;
                    ...
                    else
                    {
                            ...
                            if(confirm('Do you really want to add this testimonial?'))
                                    {
 
                        $.ajax({

                                type:'post',
                                url:'php/addTesti.php',
