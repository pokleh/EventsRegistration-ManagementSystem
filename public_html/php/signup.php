...
else
{
    ...
    $to= $emailAddress;
    $subject="Activation Code For Fab Events";
    $from = 'fabevents30@gmail.com';
    $body='Your Activation Code is '.$code.' Please Click On This link <a href="verification?token='.$code.'">'.$code.'</a>to activate your account.';
    $headers = "From:".$from;
