...
<ul>
	...
	<li>
	<img src="img/dp.jpg" alt=""style="width:200px;" >

	<br>
	<input type="radio" name="radio" id="radio" class="radio1" value="1">
	</li>
	<li>
	<img src="img/pay1.png" alt="" style="width:200px;">
	<br>
	<input type="radio" name="radio" id="radio"  class="radio2" value="2">
	</li>
...
$row = $result->fetch_assoc();
 ...
 <h2 class="card-title">Total Price: <span style="color:orange;">₱<?php echo number_format($row['eventPrice'] + 10000) ?>.00 </span></h2>
...
<input type="text" id="eventPrice" value="<?php echo $row['eventPrice'] + 10000 ?>" hidden>
...
$(document).ready(function(){
	...
	var paymentOption = $("#radio:checked").val();
	var eventTitle = $("#eventTitle").val();
	var eventPrice = $("#eventPrice").val();
	var id  = '<?php echo $id ?>';
	var radioStat = $("#radioStat").val();
	if(radioStat == "")
	{
		$(".alert").show();
	}
	else if(paymentOption == 2)
	{
		...
		window.location = 'checkout.php?event=' + eventTitle + '&price=' + eventPrice + '&id=' + id;
	}
	...
	$.ajax({
			...
			type:'POST',
			url:'php/ajax_request/directPayment.php',
			data:{id:id},
