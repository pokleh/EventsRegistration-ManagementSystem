...
else
{
	...
	if($connection->query("INSERT INTO user_account(fullName,address,birthDay,contactNumber,emailAddress,username,password,class)VALUES('$fullName','$address', '$birthday' , '$contactNumber' , '$emailAddress','$username','$hashpassword','admin')"))
	{
