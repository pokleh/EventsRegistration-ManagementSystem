...
<?php include('php/header.php') ?>
        ...
        <section class="home_contact_area">
			...
			<div class="h_right_form" >
                ...
                <h4 style="color:white;margin-top:15px;">Sign up now <br>  and make Reservation</h4>
				<div class="h_form_inner" style="">
                    ...
                    <div class="form-group col-md-12">
                        <div class="alert alert-danger" style="display:none;"></div>
                          <div class="g-recaptcha" data-sitekey="6Ldn738UAAAAAN1pRaxhbDi4YbWMHmPzySkT8LoV"></div> <br>
                           <div id="loading" style="display:none;"><img src="img/loading2.gif" alt="" style="width:40px;height:40px;position:absolute;"></div> <a style="float:right;cursor:pointer;" id="submit" class="btn submit_btn form-control green_btn">Submit</a>
